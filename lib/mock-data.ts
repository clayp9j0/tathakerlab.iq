...
export const mockEvents: Event[] = [
  ...
  },
  {
    ...
    price: "150.00",
    featured: false,
    description: "The Dubai Comedy Festival brings together the funniest comedians from around the world for a week of laughter and entertainment.",
    ticket_categories: [
      {
        id: 4,
  ...
  },
  {
    ...
    price: "350.00",
    featured: true,
    description: "Witness the world's top MMA fighters battle it out in the octagon at UFC Fight Night Dubai.",
    ticket_categories: [
      {
        id: 9,
  ...
  {
    id: 8,
    title: "Dubai International Jazz Festival",
    date: "July 5-7, 2024",
    time: "7:00 PM",
    ...
    price: "295.00",
    featured: false,
    description: "The Dubai International Jazz Festival brings together world-class jazz musicians for three nights of smooth sounds under the stars.",
    ticket_categories: [
      {
        id: 18,
        name: "Regular",
  ...
  },
  {
    ...
    price: "0.00",
    featured: false,
    description: "Celebrate Dubai's diverse culinary scene at the Dubai Food Festival.",
    ticket_categories: [
      {
        id: 24,
        name: "Free Entry",
